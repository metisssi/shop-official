...
class RealEstateBot {
    ...
    async handleOperatorIdInput(chatId, userId, text, sessionData) {
        ...
        try {
            ...
            // ИСПРАВЛЕНО: убираем backticks из Markdown, используем обычный текст
            const successMessage = `✅ Оператор "${escapedName}" успешно создан!\n\n` +
            ...
            try {
                ...
                await this.bot.sendMessage(telegramId, welcomeMessage, { parse_mode: 'Markdown' });
